...
function Account() {
  const { id } = useParams();
  const {control, watch ,  register, handleSubmit, formState: { errors }, reset, setValue } = useForm();
  ...
  const handleEditorChange = (content) => {
    ...
    console.log('Editor Content Before Update:', editorContent);
    
    if (content !== editorContent) { // Kiểm tra nếu nội dung đã thay đổi
...
const handleEdit = (post) => {
  ...
  const handleDelete = async (postId) => {
    const confirmed = await DialogService.showConfirmationDialog('post', postId);
    if (confirmed) {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (fileAudio) {
        ...
        data.audio = await uploadFile(fileAudio, audioPath, setAudioUploadProgress);
      }
          ...
          <div className="col-md-12">
            <div className="content content-full-width">
                ...
                <div className="profile-header">
                  ...
                  <div className="profile-header-content">
                    ...
                    <div className="profile-header-info">
                      <h4 className="m-t-10 m-b-5">{userInfo?.username}{userInfo.isticket === "active" && (
                        <img
                  ...
                  <ul className="profile-header-tab nav nav-tabs mt-5">
                    <li className="nav-item">
                      <a id="posts-tab" data-bs-toggle="tab" href="#posts" role="tab" aria-controls="posts" aria-selected="false" className="nav-link show active">BÀI VIẾT</a>
                    </li>
                    <li className="nav-item">
                      <a id="info-tab" data-bs-toggle="tab" href="#info" role="tab" aria-controls="info" aria-selected="true" target="__blank" className="nav-link ">THÔNG TIN</a>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                      <a id="follow-tab" data-bs-toggle="tab" href="#follow" role="tab" aria-controls="follow" aria-selected="false" className="nav-link">THEO DÕI</a>
                    </li>
                  </ul>
              ...
              <div className="profile-content">
                                          ...
                                          <div className="timeline-header">
                                            <div className=" text-centercol-md-12 d-flex justify-content-between align-items-center">
                                              <div className="d-flex align-items-center ">
                                                ...
                                                <span className="time mx-2">{formatDate(post.create_date)}</span>
                                              </div>
                                              ...
                                              <div style={{ position: 'relative', display: 'inline-block' }} className=' mx-2'>
                                                ...
                                                {isDropdownOpen === post.id && (
                                                  <ul
                                                    ...
                                                    className='border'
                                                  >
                                                    <li style={{ padding: '5px 0', cursor: 'pointer' }} onClick={() => handleEdit(post)}>
                                                      <a class="dropdown-item" >Sửa</a>
                                                    </li>
                                                    {/* Modal */}
                                                    <Modal show={showModal} onHide={handleClose} size="lg" className=''>
                ...
                render={({ field }) => (
                    <MyEditor
                        value={descriptionValue} // Pass the current value
            ...
            />
                                                          ...
                                                          <div className="row">
                                                            <div className="col text-end">
                                                              <Button variant="secondary" className="mt-5 mx-1" onClick={handleClose}>
                                                                Hủy
                                                              </Button>
                                                    ...
                                                    <li style={{ padding: '5px 0', cursor: 'pointer' }} onClick={() => handleDelete(post.id)}>
                                          ...
                                          <div className="timeline-likes">
                                            <div className="stats-right">
                                              <span className="stats-text mx-1">{post.total_shares} Chia sẻ</span>
                                            ...
                                            <div className="stats">
                                              ...
                                              <span className="stats-total ms-3"> <label className="bi-headphones me-1 fs-5"></label>{post.view}</span>
                                            </div>
                                          </div>
                                          <div className="timeline-footer">
                                            <a href="javascript:;" className="bi-heart me-4 mx-1 m-r-15 text-inverse-lighter mx-1">
                                            </a>
                                            <a
                                              href="javascript:;"
                  ...
                  <div className="tab-pane fade" id="follow" role="tabpanel" aria-labelledby="follow-tab">
                    <Follow />
                  </div>
                  {/* nôi dung bài đăng */}
