...
module.exports = class Favourite {
  ...
  static async countFavourite() {
   ...
   // models/favourite.js
   static incrementFavouriteCount(postId, customerId) {
    return new Promise((resolve, reject) => {
...
static createFavourite(postId, customerId) {
    return new Promise((resolve, reject) => {
        const query = 'INSERT INTO favourite (post_id, customers_id, date) VALUES (?, ?, NOW())';
